...
class Classifieds extends React.Component {
    render() {
		...
		<div class="container">
			<span class="agile-breadcrumbs"><a href="#"><i class="fa fa-home home_1"></i></a> / <span>All Ads</span></span>
		</div>
	</div>
		...
		<div class="container">
			...
			<h2 class="w3-head">All Classifieds</h2>
			...
			<div class="all-categories">
				...
				<ul class="all-cat-list">
					<li><a href="#">Mobiles <span class="num-of-ads">(5,78,076)</span></a></li>
					<li><a href="#">Electronics & Appliances  <span class="num-of-ads">(3,66,495)</span></a></li>
					<li><a href="#">Real Estate  <span class="num-of-ads">(45,450)</span></a></li>
					<li><a href="#">Furniture    <span class="num-of-ads">(1,77,145)</span></a></li>
					<li><a href="#">Pets   <span class="num-of-ads">(1,81,250)</span></a></li>
					<li><a href="#">Books, Sports & Hobbies    <span class="num-of-ads">(66,822)</span></a></li>
					<li><a href="#">Fashion   <span class="num-of-ads">(29,156)</span></a></li>
					<li><a href="#">Kids   <span class="num-of-ads">(25,699)</span></a></li>
					<li><a href="#">Services   <span class="num-of-ads">(2,15,895)</span></a></li>
					<li><a href="#">Cars   <span class="num-of-ads">(2,15,306)</span></a></li>
				</ul>
			</div>
