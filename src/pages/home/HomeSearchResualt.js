...
class HomeSearchResualt extends Component { 
      ...
      componentWillMount(){
        const passedItems = this.props.location.state && this.props.location.state.items;
        
        if(typeof passedItems != "undefined"){
            this.setState({items: passedItems});
        }else{
...
export default HomeSearchResualt;
