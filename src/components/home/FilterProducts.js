...
import {SideNav, Table, Collection, CollectionItem, Badge, Tabs, Tab, Collapsible, CollapsibleItem, Icon, Input, Modal, Button, Card, CardTitle, Col, Row, CardPanel, Carousel, Slider, Slide, Autocomplete, Chip, Tag} from 'react-materialize';
      ...
      <div className="filter-options">
        <div className="filter-option">
          ...
          <CardPanel className='white' textClassName='black-text' filterable>
              <Row>
              <h5>Search Results for: Electronics</h5>
              <br/>
